...
## [4.4.1](https://github.com/telekom-mms/ansible-collection-acme/tree/4.4.1) (2026-06-04)
...
- Update actions/checkout digest to df4cb1c [\#244](https://github.com/telekom-mms/ansible-collection-acme/pull/244) ([renovate[bot]](https://github.com/apps/renovate))
- Update nginx Docker digest to 5aca995 [\#243](https://github.com/telekom-mms/ansible-collection-acme/pull/243) ([renovate[bot]](https://github.com/apps/renovate))
- Update nginx Docker digest to 800e7c9 [\#242](https://github.com/telekom-mms/ansible-collection-acme/pull/242) ([renovate[bot]](https://github.com/apps/renovate))
- Update nginx Docker digest to 06aa3d7 [\#241](https://github.com/telekom-mms/ansible-collection-acme/pull/241) ([renovate[bot]](https://github.com/apps/renovate))
...
- chore\(deps\): update actions/checkout action to v6 [\#208](https://github.com/telekom-mms/ansible-collection-acme/pull/208) ([renovate[bot]](https://github.com/apps/renovate))
...
- chore\(deps\): update actions/checkout digest to 93cb6ef [\#206](https://github.com/telekom-mms/ansible-collection-acme/pull/206) ([renovate[bot]](https://github.com/apps/renovate))
- chore\(deps\): update ansible/ansible-lint action to v25.11.0 [\#205](https://github.com/telekom-mms/ansible-collection-acme/pull/205) ([renovate[bot]](https://github.com/apps/renovate))
- chore\(deps\): update nginx docker digest to 1beed3c [\#204](https://github.com/telekom-mms/ansible-collection-acme/pull/204) ([renovate[bot]](https://github.com/apps/renovate))
- chore\(deps\): update nginx docker digest to f547e3d [\#203](https://github.com/telekom-mms/ansible-collection-acme/pull/203) ([renovate[bot]](https://github.com/apps/renovate))
- chore\(deps\): update nginx docker digest to 029d446 [\#202](https://github.com/telekom-mms/ansible-collection-acme/pull/202) ([renovate[bot]](https://github.com/apps/renovate))
- Update Ansible versions to current, fix tests [\#201](https://github.com/telekom-mms/ansible-collection-acme/pull/201) ([schurzi](https://github.com/schurzi))
- chore\(deps\): update nginx docker digest to d5f28ef [\#200](https://github.com/telekom-mms/ansible-collection-acme/pull/200) ([renovate[bot]](https://github.com/apps/renovate))
- chore\(deps\): update actions/setup-python action to v6 [\#199](https://github.com/telekom-mms/ansible-collection-acme/pull/199) ([renovate[bot]](https://github.com/apps/renovate))
...
- chore\(deps\): update ansible/ansible-lint action to v25.9.2 [\#196](https://github.com/telekom-mms/ansible-collection-acme/pull/196) ([renovate[bot]](https://github.com/apps/renovate))
